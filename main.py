...
with st.sidebar.expander('About this app'): 
     st.write("This is an open source analysis web app tool to further analyze material selection data.                   This webapp is created by Cizer and the source code can be seen on the following link")
